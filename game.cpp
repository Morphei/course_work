...
void game::loadResources()
{
    if(state == MAIN_MENU)
    {
        background.loadFromFile("/home/morphei/course_work/resources/main_background_800x600.jpg");
        background_sprite.setTexture(background);
        mainFont.loadFromFile("/home/morphei/course_work/resources/GoodDog.otf");
    ...
    if(state == GAME)
    {
        ...
        background.loadFromFile("/home/morphei/course_work/resources/grass_background.jpg");
        background_sprite.setTexture(background);
    }
}
